  ...
  const validateFields = () => {
    ...
    if (isValid && email !== confirmEmail) {
      Swal.fire({
        icon: "error",
        title: "Error de Email",
        text: "Los correos no coinciden. Por favor, intenta nuevamente.",
      });
      return false;
    }
  ...
  const deleteOrderFromFirestore = async (orderId) => {
    try {
      ...
      Swal.fire({
        ...
        text: "Ocurrió un error al intentar eliminar la orden. Por favor, comunicate con nosotros",
      });
    }
  };
    ...
    <div className="form-datos">
      ...
      <label>
        ...
        <select value={selectedOption1} onChange={(e) => setSelectedOption1(e.target.value)}>
          ...
          <option value="opcion1">Banco Santa Fe</option>
          <option value="opcion2">Banco Entre Ríos</option>
